#include "opencv2/core/utility.cpp"
#include "opencv2/imgproc.cpp"
#include "opencv2/imgcodecs.cpp"
...
static void help()
{
    std::cout << "\nThis program demonstrates the use of calcHist() -- histogram creation.\n"
              << "Usage: \n" << "demhist [image_name -- Defaults to ../file.jpg]" << std::endl;
}
const char* keys =
{
    "{help h||}{@image|../file.jpg|input image file}"
};
